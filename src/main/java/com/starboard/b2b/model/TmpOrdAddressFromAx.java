...
@Entity
@Table(name = "tmp_ord_address_from_ax")
public class TmpOrdAddressFromAx {
	...
	public TmpOrdAddressFromAx() {
	}

	public TmpOrdAddressFromAx(long orderAddressId, long orderId, String orderFname, String orderLname, String orderAddr, String subdistrict,
