...
public class TmpAddr {
	...
	public TmpAddr(long addrId, long custId) {
		this.addrId = addrId;
		this.custId = custId;
	}

	public TmpAddr(long addrId, long custId, String custCode, Long contactId, String address, Long subDistrict, Long district, Long province,
