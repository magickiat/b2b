...
/**
 * TmpOrders generated by hbm2java
 */
@Entity
@Table(name = "tmp_orders")
public class TmpOrders implements java.io.Serializable {
	...
	public TmpOrders(long orderId, String orderCode, String soCode, Long custId, String custCode, Long memberId,
			Long brandGroupId, BigDecimal discount, BigDecimal price, BigDecimal totalPrice, BigDecimal shipPrice,
			BigDecimal netPrice, String productUnitId, String trackId, String shippingId, String paymentId,
			String paymentCurrencyId, String paymentTermId, String paymentMethodId, String orderStatus, Date orderDate,
			Date expectShipmentDate, String remarkCustomer, String remarkOrders, String dtsSystem, Date dtsUpdate) {
		this.orderId = orderId;
