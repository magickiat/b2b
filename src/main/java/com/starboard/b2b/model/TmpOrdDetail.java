...
public class TmpOrdDetail {
	...
	public TmpOrdDetail(long orderDetailId) {
		this.orderDetailId = orderDetailId;
	}

	public TmpOrdDetail(long orderDetailId, Long orderId, Long productId, Long amount, Long status, BigDecimal price, String productUnitId,
