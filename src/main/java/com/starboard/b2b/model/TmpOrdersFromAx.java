...
@Entity
@Table(name = "tmp_orders_from_ax")
public class TmpOrdersFromAx {
	...
	public TmpOrdersFromAx() {
	}

	public TmpOrdersFromAx(long orderId) {
		this.orderId = orderId;
	}

	public TmpOrdersFromAx(long orderId, String orderCode, String soCode, Long custId, String custCode, String custUserId, Long memberId, Long brandGroupId,
