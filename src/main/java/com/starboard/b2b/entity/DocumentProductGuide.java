...
public class DocumentProductGuide implements Serializable {
    
    /** Creates a new instance of DocumentProductGuide */
    public DocumentProductGuide() {
    }
    public DocumentProductGuide(
            long documentId	
            , String documentName	
	...
	public String toString() {
		return "DocumentProductGuide [documentId=" + documentId
				+ ", documentName=" + documentName + ", productPriceGroupName="
				+ productPriceGroupName + ", documentPath=" + documentPath
				+ ", brandGroupId=" + brandGroupId + ", brandGroupName="
				+ brandGroupName + ", userCreate=" + userCreate
				+ ", userUpdate=" + userUpdate + ", timeCreate=" + timeCreate
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DocumentProductGuide other = (DocumentProductGuide) obj;
