...
public class Product implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (that.getProductIntro() != this.getProductIntro()) {                      // FILM:EDIT
                return false;
        }
        ...
        if (!(that.getProductPictureMedium() == null ? this.getProductPictureMedium() == null
                        : that.getProductPictureMedium().equals(this.getProductPictureMedium()))) {
                return false;
        }
