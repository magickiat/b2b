...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="row">
			<div>บทวิเคราะห์ ไมโครซอฟท์ยุคใหม่ กับยุทธศาสตร์ 3 ขา
				"สามเหลี่ยมเขยื้อนภูเขา"</div>
			<div>27/09/15 22:45</div>
			<div>หลังจากที่ผมเขียนบทความ แอปเปิล vs กูเกิล -
				...
				ผมคิดว่าเห็นภาพของไมโครซอฟท์ชัดเจนขึ้น เลยมาสรุปให้อ่านกันครับ</div>
		</div>
		<hr>
		<div class="row">
			...
			<div>
				...
				เป็นผู้ให้บริการเชิงพาณิชย์รายแรกในไทยในปี พ.ศ. 2537</div>
		</div>
		<hr>
