...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="col-sm-6 text-left" style="padding: 0px;">
						<a
							href="<c:url value="/frontend/order/download-template?brand_id=${brandId}"/>"
							title="download excel order template" class="btn btn-default">Download
							Excel Order</a>
					</div>
	...
	<script>
		jQuery(document).ready(
				function() {
					$('#upload-form button[role="upload"]').on('click',
							function(event) {
								app.order.upload();
							});
				});
