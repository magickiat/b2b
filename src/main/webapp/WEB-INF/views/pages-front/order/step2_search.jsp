	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 bg_color">
				...
				<!-- Search condition -->
				<div class="">
					<form:form id="searchProductModelForm" modelAttribute="searchProductForm"
						servletRelativeAction="/frontend/order/step2/search-action" method="get">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label class="radio-inline"><form:radiobutton path="showType" value="image"
											onclick="searchPage(1)" />Images </label> <label class="radio-inline"><form:radiobutton
