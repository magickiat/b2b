		...
		<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-12 bg_color showline2">
					<div class="row col-md-6 row-header2 header2 txtupper">Search
						Contact us</div>
					<div class="" style="margin-top: 10px;">
						<form action='<c:url value="/backend/contactus/add" />'>
							<input type="submit" value="Add Contact"
								class="btn btn-default pull-right" style="width: 100px;" />
						</form>
					</div>
			...
			<c:choose>
											...
											<td>
												<form id="${ contact.contactId }"
													...
													<input type="hidden" id="csrftoken_"
														...
														type="hidden" name="id" value="${ contact.contactId }" />
				...
				<c:otherwise>
					...
					<div class="row bg_color">
						<div class="col-md-12 bg_color showline2">
							<div style="padding-bottom: 10px; padding-top: 10px;">Not
								found contact us</div>
						</div>
					</div>
				</c:otherwise>
			</c:choose>
