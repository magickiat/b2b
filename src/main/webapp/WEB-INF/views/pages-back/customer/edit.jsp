...
<head>
	...
	<title>Edit Customer - Starboard Windsurfing</title>
			...
			<div class="col-sm-12 bg_color">
				<div class="row">
					...
					<div class="col-sm-3" style="margin-top: 10px;">
						...
						<button type="button" class="btn btn-default pull-right" onclick="javascript:window.location.href = '${addAddressUrl}'">Add Address</button>
					</div>
				</div>
			...
			<div class="col-sm-12 bg_color">
				<div class="row">
					...
					<div class="col-sm-3" style="margin-top: 10px;">
						...
						<button type="button" class="btn btn-default pull-right" onclick="javascript:window.location.href = '${addContactUrl}'">Add Contact</button>
					</div>
				</div>
				<div class="bg_color">
