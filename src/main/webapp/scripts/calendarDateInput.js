...
var UnselectedMonthText = 'โปรดระบุ'; // Text to display in the 1st month list item when the date isn't required
...
function SetPickedMonth(PickedYear, PickedMonth, PickedDay) {
   ...
   if( myFunction == null || myFunction(this,PickedYear, PickedMonth, PickedDay)){
...
function DateInputAddEvent(DateName, event, functionName, setMaxDate) {
	var el = document.getElementById(DateName);
